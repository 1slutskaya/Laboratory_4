...
public class Config extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        realDate = date_str;
        date_str = 0 + " DAYS LEFT BEFORE " + now.get(Calendar.DAY_OF_MONTH) + "-" + (now.get(Calendar.MONTH) + 1) + "-" + now.get(Calendar.YEAR);
        ...
        datePicker.setOnDateChangedListener(new DatePicker.OnDateChangedListener() {
            ...
            public void onDateChanged(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                date_str = days + " DAYS LEFT BEFORE " + dayOfMonth + "-" + (monthOfYear + 1) + "-" + year;
    ...
    public void onClick(View v) {
        ...
        notify.title("IT'S HERE BOI").time(now).build();
